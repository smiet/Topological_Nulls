...
\begin{block}{The topological Index of a 3D null}
    Let $\mathbf{B}(\mathbf{x}): \mathbb{R}^3\rightarrow \mathbb{R}^3$ be a vector field.
...
\begin{block}{The nulls around a dipole}
    \begin{figure}
        \includegraphics[width=\twocolwid]{
    \end{figure}
...
%
%\begin{center}
%    \begin{minipage}{0.75\linewidth}%left two columns
%
%        begin{minipage}{0.5\linewidth}%leftmost column
%        \begin{Large}
%        \vspace{0.5cm}
%        ~\\
%        ~\\
